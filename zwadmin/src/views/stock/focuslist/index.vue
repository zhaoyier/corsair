  ...
  <div class="dashboard-container">
    ...
    >
      ...
      <el-table-column label="关注价格" width="110" align="center">
        <template slot-scope="scope">
          <el-tag type="warning" effect="dark">{{ scope.row.focusPrice }}</el-tag>
        </template>
      </el-table-column>
      ...
      <template slot-scope="scope">
        ...
        <el-button
          @click.native.prevent="cancelFocus(scope.$index, tableData)"
          type="text"
          size="small">
          取消关注
        </el-button>
...
<script>
import { getFocusList } from '@/api/stock'
