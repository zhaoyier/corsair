...
func init() {
	...
	RegisterEzOrmObjByID("dcat", "Counter", newCounterFindByID)
	RegisterEzOrmObjRemove("dcat", "Counter", CounterMgr.RemoveByID)
...
func initCounterIndex() {
	...
	if err := collection.EnsureIndex(mgo.Index{
		...
		panic("ensureIndex digger.Counter Key error:" + err.Error())
	}
...
func (m *_CounterMgr) GetCol() (session *mgo.Session, col *mgo.Collection) {
	if mgoInstances == nil {
		return db.GetCol("digger", "dcat.Counter")
	}
	return getCol("digger", "dcat.Counter")
}
